...
Админка trade-news слушает только `127.0.0.1:ADMIN_PORT` (по умолчанию 10000) и снаружи
...
- Если `ADMIN_PORT` в `.env` отличается от 10000, поменяйте порт в строке `proxy_pass` конфига.
