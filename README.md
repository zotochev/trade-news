...
**Статус:** этап 1 (сбор, дедупликация), этап 3 (LLM-разметка), админка, подписка в Telegram. План в [TODO.md](TODO.md).
...
| `/subscribers` Подписчики | список и события; предпросмотр порога рассылки (этап 4) |
